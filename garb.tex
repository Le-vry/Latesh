...
\title{Parallellisering av nätverksanrop i Flutter/Firebase applikationer}

\author{{\rm Jonathan Karlgren} \\ {\rm Elliot Lidman} \\
...
\subsubsection{Warm- och cold-boot}
...
kodbas.~\cite{flutter_faq}\\[0.5\baselineskip]
...
För att kunna besvara frågeställningen togs ett test-script fram, som använder
Flutters \texttt{IntegrationTest\allowbreak Widgets\allowbreak Flutter\allowbreak Binding} med en initial cold-boot
för varje sida där firestores caching är inaktiverat, för att snabbt och
...
en csv-fil för att sedan kunna analyseras med hjälp av Python. 
