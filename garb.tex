...
baserades i stället på warm-mätningar. 

Som beskrivande statistik rapporterades antal mätningar, medelvärde,
standardavvikelse, 95\% konfidensintervall, nätverkslatens och p95-värden för respektive sida och implementation.  Testet genomfördes separat för \textit{Profile page} och
\textit{Leaderboard page} för att undvika att sidspecifika beteenden
sammanblandas i ett gemensamt test. 
...
\subsection{Sekventiell vs parallell laddningstid (95\% KI)}

\noindent
\begin{minipage}[t]{\columnwidth}
 Med hjälp av medelvärdena och 95\% konfidensintervallen från Tabell~\ref{tab:sekventiell} och Tabell~\ref{tab:parallel} kunde diagramet nedan framställas, som är en jämförelse av laddningstiderna för sekventiella och parallella anrop uppdelat på databasstorlek och sida.
\end{minipage}
...
\begin{strip}
  ...
  \includegraphics[width=\textwidth]{plots/combined_comparison.png}

  \captionof{figure}{Jämförelse av laddningstider (medelvärde och 95\% konfidensintervall) för sekventiella och parallella anrop, uppdelat på databasstorlek och sida}
  \label{fig:95ci-leaderboard}
\end{strip}

\vspace*{0.5\baselineskip}

Utifrån diagrammet i Figur~\ref{fig:95ci-leaderboard} kan det observeras att parallella anrop konsekvent resulterade i kortare laddningstider jämfört med sekventiella anrop, och att 95\% konfidensintervallen för de olika anropenstyperna inte överlappar varandra för någon av databasstorlekarna eller sidorna, så indikerar det att skillnaderna i laddningstider är statistiskt signifikanta.
