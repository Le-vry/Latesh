...
\begin{itemize}
    \item Är parallellisering av nätverksanrop med \texttt{Future.wait()} en lämplig metod för att förbättra laddningstider i en Flutter- och Firebase-baserad applikation som Neatify?
\end{itemize}
